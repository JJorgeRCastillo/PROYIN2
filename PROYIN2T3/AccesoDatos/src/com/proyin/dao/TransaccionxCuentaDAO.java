...
public class TransaccionxCuentaDAO implements IDAO {
	...
	private static TransaccionxCuentaDAO _instance = null;

	private TransaccionxCuentaDAO() {
	}

	public static TransaccionxCuentaDAO getInstance() {
		if (_instance == null) {
			_instance = new TransaccionxCuentaDAO();
		}
		return _instance;
	}
	@Override
	public boolean insert(IDTO dto) throws Exception {
		...
		try{
			...
			cstm.setString(1, objTransaccionCuenta.getObjOficinaCuenta().getIdOficina());
