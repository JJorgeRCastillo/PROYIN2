   <!-- jQuery -->
    ...
    <!-- Flot plugins -->
    <script src="resources/production/js/flot/jquery.flot.orderBars.js"></script>
    <script src="resources/production/js/flot/date.js"></script>
    <script src="resources/production/js/flot/jquery.flot.spline.js"></script>
    <script src="resources/production/js/flot/curvedLines.js"></script>
    <!-- jVectorMap -->
    <script src="resources/production/js/maps/jquery-jvectormap-2.0.3.min.js"></script>
    <!-- bootstrap-daterangepicker -->
    <script src="resources/production/js/moment/moment.min.js"></script>
    <script src="resources/production/js/datepicker/daterangepicker.js"></script>

    <!-- Custom Theme Scripts -->
    <script src="resources/production/js/custom.js"></script>
